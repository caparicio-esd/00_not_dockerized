 ...
 *
 * Chart defaults
 * Que son modificaciones generales para hacer overriding
 * Te vienen de puta madre para hacer estilos propios y vainas así
 */
...
/**
 *
 * Esto lo hace el notas para que si no estás n contxto
 * O no hay un canvas moderno, mejor que no haga animaciones para hacer transiciones
 * entre estados
 */
var useExcanvas = typeof window.G_vmlCanvasManager === "object" && window.G_vmlCanvasManager !== null && typeof window.G_vmlCanvasManager.initElement === "function";
if (useExcanvas) Chart.defaults.global.animation = false;

/**
 *
 * Angularización del proyecto
 * Tiene un module chart.js sin dependencias
 * Usa un provides
 * Usa un Factory
 * Carga los elementos del front como directivas
 *
 */
return angular
  .module("chart.js", [])
...
/**
 *
 * Providers son como factories y servicios de bajo nivel, tenemos más control
 * Factories son objetos que instanciamos
 * Servicios son objets singleton (podrían venir de una factory, pero no hay falta)
 *
 * Provider es como un factory pero qeu te permite configurarlo
 * con la interfaz config y run
 *
 *
 */
...
/**
 *
 * Factory es como una clase normal y corriente
 *
 */
